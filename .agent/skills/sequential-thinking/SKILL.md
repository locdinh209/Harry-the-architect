...
description: >-
  Structured problem-solving through iterative reasoning with revision and
  branching capabilities. Use when complex problems require systematic step-by-step
  reasoning, when you need to revise thoughts or branch into alternatives, or when
  dynamically adjusting scope. Ideal for multi-stage analysis and design planning.
license: MIT
---
