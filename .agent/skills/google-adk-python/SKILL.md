...
description: >-
  Build AI agents with Google's Agent Development Kit (ADK) Python. Use when
  creating multi-agent systems, implementing workflow agents (sequential,
  parallel, loop), integrating tools (google_search, code_execution), deploying
  to Vertex AI or Cloud Run, or evaluating agent performance.
license: Apache-2.0
version: 1.0.0
---
